...
## Description  
Note: The current boilerplate repo is here [WIP Ultimate Backend Boilerplate](https://github.com/SevenSquare-Tech/multi-tenant-saas-boilerplate). This repo is currently houses the microservice packages [Next Branch](https://github.com/SevenSquare-Tech/multi-tenant-saas-boilerplate/tree/next/packages).
...
to identify your tenants. The goal is to give your next big project that extra leap to awesomeness. To get started read the instructions below. With support for both [Event Store](https://eventstore.org) and [NATS Streaming](https://nats.io) for event streaming and Kafka coming soon.
...
* ✅ [React SSR Starter Kit](https://github.com/SevenSquare-Tech/multi-tenant-saas-boilerplate)
* ❌ (WiP) Documentation  
* ✅ (WiP) Webhooks  
...
import { MongoModule } from '@nodejsDev/repo-orm/database';  
